...
const updateUserRepo = (userId, updateUser) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield user_model_1.default.findOneAndUpdate({ uid: userId }, updateUser, { new: true });
        if (result) {
            return true;
        }
        else {
...
//     try {
//         const result = await UserModel.findOneAndDelete({ uid: userId }, { $pull: { tweetId: tweetId } },);
//         if (result) {
//             return true;
//         } else {
//             return false;
...
const deleteUserWithTweetIdRepo = (userId, tweetId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield user_model_1.default.updateOne({ uid: userId }, { $pull: { tweets: tweetId } });
